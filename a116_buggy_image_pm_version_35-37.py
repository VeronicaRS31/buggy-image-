...
while (n < num_legs/2):
  ...
  spider_body.pendown()
  spider_body.setheading(distance_legs*n-45+30)
  spider_body.circle(-60,120)
  n = n + 1
n=0
while (n < num_legs/2):
  spider_body.penup()
  spider_body.goto(0,20)
  spider_body.pendown()
  spider_body.setheading(distance_legs*n -45+150)
  spider_body.circle(60,120)
  n = n + 1


# eyes of this creepy spider :)
spider_body.pencolor("purple")
spider_body.penup()
spider_body.goto(5,-20)
spider_body.pendown()
spider_body.fillcolor("purple")
spider_body.begin_fill()
spider_body.circle(5)
spider_body.end_fill()
spider_body.penup()
spider_body.goto(-15,-20)
spider_body.pendown()
spider_body.fillcolor("purple")
spider_body.begin_fill()
spider_body.circle(5)
...
spider_body.penup()
spider_body.goto(7,-18)
spider_body.pendown()
spider_body.circle(2)
spider_body.penup()
spider_body.goto(-12,-18)
spider_body.pendown()
spider_body.circle(2)
